...
public class GunSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && Time.time >= nextTimeToFire && semi && magazineSize > 0 && canShoot)
        {
            AddRecoil();
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && Time.time >= nextTimeToFire && melee)
        {
            nextTimeToFire = Time.time + 1f / fireRate;
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && magazineSize == 0)
        {
            noAmmoSound.Play();
        }
    ...
    void Shoot()
    {
        ...
        {
            Debug.Log("Hit: " + hit.transform.name); // Check what was hit
            magazineSize--;
            ammoNeeded++;
